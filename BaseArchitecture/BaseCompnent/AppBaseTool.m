...
@interface AppBaseTool ()

@end

@implementation AppBaseTool

static AppBaseTool *appBaseTool = nil;
+ (instancetype)shareManager {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        appBaseTool = [[self alloc] init];
    });
    return appBaseTool;
}
...
+ (NSString *)getDeviceIDFV {
    NSString * identifierForVendor = [UIDevice identifierByKeychain];
